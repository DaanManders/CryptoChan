...
<head>
    ...
    <script src="../JS/Register.js"></script> <!----- Link JavaScript | HTML Import ----->
...
<body class="body-container w-100 h-100">
    <div class="register-container d-flex align-items-center justify-content-center">
        <div class="register-card ps-4 pe-4 pt-5 pb-5">
            <form>
                <!----- Heading | Register Card ----->
                <div class="register-heading mb-5">
                    <h1 class="header-one fw-bolder m-0">Create an Account</h1>
                    <h2 class="header-two fw-bolder">
                        Already have an Account? 
                        <span id="login" class="login-link">Login</span>
                    </h2>
                </div>
                <!----- Full Name | Register Card ----->
                <div class="account-name d-flex align-items-center mb-3">
                    <input class="input-medium me-3 fw-bolder" type="text" placeholder="First Name" id="FirstName" required>
                    <input class="input-medium fw-bolder" type="text" placeholder="Last Name" id="LastName" required>
                </div>
                <!----- Account Credentials | Register Card ----->
                ...
                <div class="account-creation mb-3">
                    <button class="create-account-btn border-0 fw-bolder" type="button" id="create">Create Account</button>
                </div>
                <!----- Third Party | Register Card ----->
